...
If you want to include a literal `\\@root/` url without having it rewritten you can escape it with a preceeding backslash, `\\\\@root/`. (Note that you may need to double-escape the backslash itself to avoid it being consumed by the Markdown or Monk parser.)
